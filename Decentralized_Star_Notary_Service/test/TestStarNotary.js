...
it('lets 2 users exchange stars', async() => {
    ...
    // let msgSender = await instance.msgSenderAddress()
    // console.log(msgSender)
    await instance.createStar('Test Star1', starId1, {from: user1});
    await instance.createStar('Test Star2', starId2, {from: user2});
