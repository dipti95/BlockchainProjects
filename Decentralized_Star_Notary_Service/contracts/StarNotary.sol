...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require((msg.sender == sender1 || msg.sender == sender2),'Passing to star tokenId you will need to check if the owner of _tokenId1 or _tokenId2 is the sender');
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require((msg.sender == ownerOf(_tokenId)), "Check if the sender is the ownerOf(_tokenId)");
